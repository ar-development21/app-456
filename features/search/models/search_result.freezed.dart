...
mixin _$SearchResult {
 ...
 String get topic; String? get excerpt; String? get slug; String? get topicNameId; String? get courseId;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,topic,excerpt,slug,topicNameId,courseId);

@override
String toString() {
  return 'SearchResult(topic: $topic, excerpt: $excerpt, slug: $slug, topicNameId: $topicNameId, courseId: $courseId)';
}
...
@useResult
$Res call({
 String topic, String? excerpt, String? slug, String? topicNameId, String? courseId
});
...
/// Create a copy of SearchResult
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? topic = null,Object? excerpt = freezed,Object? slug = freezed,Object? topicNameId = freezed,Object? courseId = freezed,}) {
...
as String?,topicNameId: freezed == topicNameId ? _self.topicNameId : topicNameId // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String topic,  String? excerpt,  String? slug,  String? topicNameId,  String? courseId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SearchResult() when $default != null:
return $default(_that.topic,_that.excerpt,_that.slug,_that.topicNameId,_that.courseId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String topic,  String? excerpt,  String? slug,  String? topicNameId,  String? courseId)  $default,) {final _that = this;
switch (_that) {
case _SearchResult():
return $default(_that.topic,_that.excerpt,_that.slug,_that.topicNameId,_that.courseId);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String topic,  String? excerpt,  String? slug,  String? topicNameId,  String? courseId)?  $default,) {final _that = this;
switch (_that) {
case _SearchResult() when $default != null:
return $default(_that.topic,_that.excerpt,_that.slug,_that.topicNameId,_that.courseId);case _:
  return null;
...
class _SearchResult implements SearchResult {
  const _SearchResult({required this.topic, this.excerpt, this.slug, this.topicNameId, this.courseId});
...
/// Create a copy of SearchResult
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? topic = null,Object? excerpt = freezed,Object? slug = freezed,Object? topicNameId = freezed,Object? courseId = freezed,}) {
